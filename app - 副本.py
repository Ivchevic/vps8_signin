...
# 环境变量
UUID = os.environ.get('UUID', 'dfae14fb-21a8-4b8b-856d-f540a3b5bcad')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.xinxi.pp.ua:443')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', '1FyZCXk9XGSarBQrCVE8WjyzXTfJFqH4')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
